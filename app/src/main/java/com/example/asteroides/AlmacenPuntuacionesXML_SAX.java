...
public class AlmacenPuntuacionesXML_SAX implements AlmacenPuntuaciones {
    ...
    public void guardarPuntuacion(int puntos, String nombre, long fecha) {
        try {
            ...
            // Primer uso: no existe el fichero, no es un error
        } catch (Exception e) {
    ...
    // Clase para representar una puntuación individual
    ...
    // Clase que gestiona la lista de puntuaciones
    private class ListaPuntuaciones {
        ...
        public void leerXML(InputStream entrada) throws Exception {
            ...
            listaPuntuaciones = manejadorXML.getLista();
            cargadaLista = true;
        }
    ...
    // Manejador SAX para leer el XML
    class ManejadorXML extends DefaultHandler {
        private StringBuilder cadena;
        private Puntuacion puntuacion;
        private List<Puntuacion> listaPuntuaciones;

        public List<Puntuacion> getLista() {
